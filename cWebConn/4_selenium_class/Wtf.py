...
for page in pages:
    ...
    for res_button in res_list:
        ...
        try:
            ...
            driver.find_element_by_xpath('//*[contains (@href, "menu")]').send_keys(Keys.ENTER)
            html = driver.page_source
            soup = BeautifulSoup(html,'html.parser')
        ...
        cursor = conn.cursor()
        # db 저장
        sql="""INSERT INTO restaurant (res_name,res_tell,res_addr,res_runtime,res_keyword,res_latitude,res_longitude) 
        VALUES(%s,%s,%s,%s,%s,%s,%s)"""
        data=(res_name, res_tell, res_addr, res_runtime, res_keyword, res_latitude, res_longitude)
        print(data)
