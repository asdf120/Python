...
imgName = 'data/daum.png'
        # data 폴더가 미리 생성되어있어야함
req.urlretrieve(url_daum,imgName)

url_google = 'https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png'
imgName = 'data/google.png'
req.urlretrieve(url_google,imgName)
print('저장됨')
